...
static char * setFullButtons(ClientData data, Tcl_Interp * interp, 
			     char * name1, char * name2, int flags);
/*
static char * printBacktext (Tcl_Interp * interp);
static char * printHelptext (Tcl_Interp * interp);
static char * printFullButtons (Tcl_Interp * interp);
*/
...
int Gwhiptcl_Init(Tcl_Interp * interp) {
